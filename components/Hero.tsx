  ...
  return (
    ...
    <div className='flex justify-center relative my-20 z-50'>
        <div className='max-w-[89vw md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            ...
            <TextGenerateEffect 
                className='text-3xl md:text-5xl lg:text-7xl font-bold text-center mt-4'
                words='Building Seamless Experiences with Full-Stack Expertise'/>
            <p className='text-sm md:text-lg  lg:text-2xl text-center font-bold md:tracking-wider pb-5'>
            I’m Fitsum, a Full-Stack Developer Building with Next.js </p>
            <a href='#about'>
