...
const DotMatrix: React.FC<DotMatrixProps> = ({
  ...
  const uniforms = useMemo(() => {
    const colorsArray: number[][] = colors.length === 2
...
const ShaderMaterial: React.FC<{
  ...
  const getUniforms = () => {
    const preparedUniforms: { [key: string]: { value: number | THREE.Vector2 | THREE.Vector3 | THREE.Vector3[] | number[] | number[][]; type: string } } = {
